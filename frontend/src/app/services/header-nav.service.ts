...
export const STATIC_HEADER_LINKS: HeaderLink[] = [
  ...
  { id: 6, label: 'Login', path: '/login', sortOrder: 6, visible: true, isCta: false, createdAtUtc: '' },
  { id: 7, label: 'Dashboard', path: '/dashboard', sortOrder: 7, visible: true, isCta: false, createdAtUtc: '' },
  { id: 8, label: 'Enquire', path: '/contact', sortOrder: 8, visible: true, isCta: true, createdAtUtc: '' }
];
